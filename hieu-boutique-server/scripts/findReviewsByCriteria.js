#!/usr/bin/env node
// Find reviews by simple criteria (rating, date substring)
// Usage:
//   node ./scripts/findReviewsByCriteria.js --rating=5 --date="27/11/2025"
//   node ./scripts/findReviewsByCriteria.js --rating=5
...
async function main() {
  ...
  try {
    // Build query for array element match
    const elemMatch = {};
