                ...
                <form className="custommer-form" onSubmit={handleSubmit}>
                    ...
                    <div className="pay-method col12">
                        ...
                        <div className="pay-method_online pointer">
                            <img src={logoTp} alt="hieu boutique" onClick={()=>{handleSetPayService('bank')}}/>
                            <img src={logoMomo} alt="hieu boutique" onClick={()=>{handleSetPayService('momo')}}/>
                            <img src={logoVnpay} alt="hieu boutique" onClick={()=>{handleSetPayService('bank')}}/>
                        </div>
                    </div>
