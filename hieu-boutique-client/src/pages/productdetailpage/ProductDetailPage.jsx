    ...
    return(
        <main className="productpage">
            ...
            <section className="productpage_prod-detail">
                <div className="prod-img unselect">
                    <div className="img-list">
                        <img src={data?.prodData?.img} alt="hieu boutique" className='img' />
                        <img src={data?.prodData?.img} alt="hieu boutique" className='img' />
                        <img src={data?.prodData?.img} alt="hieu boutique" className='img' />
                    </div>
                    <div className="main-img">
                        <img src={data?.prodData?.img} alt="hieu boutique"/>
                    </div>
                </div>
                <div className="prod-infor">
                    ...
                    <p className="policy unselect">
                        - Hàng mua Online được đổi ở tất cả các chi nhánh thuộc hệ thống hieu boutique hoặc hỗ trợ đổi Online. <br />
                        ...
                        - Khi đổi hàng bạn cần cung cấp cho nhà Hieu số điện thoại và tên người mua hàng. <br />
