...
const LoginPage = () => {
    ...
    return(
        <div className="contain-auth">
            <p className="title-login">Hieu-Boutique</p>
...
const RegisterPage = () => {
    ...
    return(
        <div className="contain-auth">
            <p className="title-register">Hieu-Boutique</p>
            <form className="register" onSubmit={handleRegister}>
                ...
                <div className="register_term">
                    ...
                    <label htmlFor="term">Tôi đồng ý với <u>Điều khoản và chính sách của Hieu</u></label>
                </div>
