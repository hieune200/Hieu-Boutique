    ...
    return(
        <main className="newspage">
            <section className="newspage_slide">
                <div className="slide">
                    <img src={slide1} alt="hieu-boutique" />
                    <div className="short-news">
                        ...
                        <p className="short-content">Mở ra chương đầu tiên của chuyến hành trình mùa Hạ, những thiết kế ngọt ngào mang đậu màu sắc của thời trang resort trong bộ lookbook mới với tên gọi &ldquo;A SUMMER ROMANCE&rdquo; tựa như 1 bản hoà ca mùa Hạ du dương, khơi gợi lên sự an bình,...</p>
                        <u>Đọc thêm...</u>
                    </div>
                </div>
            </section>
                            ...
                            promotionList.map((promotion, index)=>{
                                return(
                                    <div className="promotion pointer" key={index}>
                                        <img src={promotion.img} alt="hieu"/>
