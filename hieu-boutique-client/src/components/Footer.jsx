        ...
        <footer className="footer">
            <section className="footer_top">
                <div className="footer_top_icon">
                    <img src={fb} alt="hieu boutique" />
                    <img src={ins} alt="hieu boutique" />
                    <img src={tiktok} alt="hieu boutique" />
                </div>
                <div className="footer_top_logo">
                    <img src={logo} alt="hieu boutique" />
                </div>
                <div className="footer_top_icon">
                    <img src={pay} alt="hieu boutique" />
                    <img src={ghn} alt="hieu boutique" />
                    <img src={ship} alt="hieu boutique" />
                </div>
            </section>
